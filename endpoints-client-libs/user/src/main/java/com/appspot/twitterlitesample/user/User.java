...
public class User extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Create extends UserRequest<Void> {
    ...
    protected Create(com.appspot.twitterlitesample.user.model.CreateUserdDTO content) {
      super(User.this, "POST", REST_PATH, content, Void.class);
    }
  ...
  public class Followed extends UserRequest<com.appspot.twitterlitesample.user.model.JsonMap> {
    ...
    protected Followed(java.lang.Integer limit, java.lang.String userKey) {
      super(User.this, "GET", REST_PATH, null, com.appspot.twitterlitesample.user.model.JsonMap.class);
  ...
  public class Followers extends UserRequest<com.appspot.twitterlitesample.user.model.JsonMap> {
  ...
  public class List extends UserRequest<com.appspot.twitterlitesample.user.model.JsonMap> {
