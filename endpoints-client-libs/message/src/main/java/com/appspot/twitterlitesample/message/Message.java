...
public class Message extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class User {
    ...
    public class Messages {
      ...
      public class List extends MessageRequest<com.appspot.twitterlitesample.message.model.JsonMap> {
        ...
        protected List(java.lang.Integer limit, java.lang.String userKey) {
          super(Message.this, "GET", REST_PATH, null, com.appspot.twitterlitesample.message.model.JsonMap.class);
  ...
  public class Post extends MessageRequest<Void> {
    ...
    protected Post(java.lang.String senderKey, com.appspot.twitterlitesample.message.model.MessageSetDTO content) {
      super(Message.this, "POST", REST_PATH, content, Void.class);
